...
from legacy.RF_Net.model.rf_net_module import RFNetModule
from legacy.RF_Net.utils.net_utils import pair
from legacy.RF_Net.utils.image_utils import clip_patch, topk_map
...
class RFNetSO(RFNetModule):
    ...
    def detectAndCompute(self, im_path, device, output_size):
        ...
        from legacy.RF_Net.utils.image_utils import im_rescale
