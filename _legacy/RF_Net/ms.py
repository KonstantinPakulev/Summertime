...
from legacy.RF_Net.utils.train_utils import parse_batch
...
if __name__ == "__main__":
    ...
    from legacy.RF_Net.utils.eval_utils import *
    ...
    PreNN, PreNNT, PreNNDR, PreRep = (PreNN / length, PreNNT / length, PreNNDR / length, PreRep / length)
