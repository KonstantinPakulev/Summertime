...
from legacy.ST_Net.utils.image_utils import warp, filter_border, top_k_map
from legacy.ST_Net.utils.model_utils import make_vgg_backbone
...
class STNetVGGModule(nn.Module):
    ...
    def detectAndCompute(self, im_path, device, output_size):
        ...
        from legacy.ST_Net.utils.image_utils import im_rescale
