...
from Net.source.nn.criterion import MSELossRF, MSELoss, HardQuadTripletSOSRLoss
...
from Net.source.utils.image_utils import select_keypoints_score, warp_points, filter_border
...
class TrainExperiment(BaseExperiment):
    ...
    def init_criterions(self):
        ...
        self.criterions[DET_CRITERION] = MSELossRF(cs.NMS_THRESH, cs.NMS_K_SIZE,
                                                   cs.TOP_K,
    ...
    def inference(self, engine, batch):
        ...
        _, kp1 = select_keypoints_score(score1, ls.NMS_THRESH, ls.NMS_K_SIZE, ls.TOP_K)
        _, kp2 = select_keypoints_score(score2, ls.NMS_THRESH, ls.NMS_K_SIZE, ls.TOP_K)
...
class TrainExperimentDetector(TrainExperiment):
    ...
    def init_optimizers(self):
        self.optimizers[OPTIMIZER] = Adam(self.models[MODEL].parameters(), lr=0.0001)
