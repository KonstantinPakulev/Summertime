...
def create_desc_coordinates_grid(out, grid_size, permute=True):
    """
    :param out: B x C x H x W
    :param grid_size: int
    :param permute: bool
...
def create_center_desc_coordinates_grid(out, grid_size):
    coo_grid = create_desc_coordinates_grid(out, grid_size)
    coo_grid = coo_grid + grid_size // 2
    return coo_grid
...
def prepare_gt_score(score, nms_thresh, k_size, top_k):
    """
    :param score: B x 1 x H x W
    :param nms_thresh: float
    :param k_size: int
